        ...
        <div>
          ...
          <div className="latest">
            ...
            <div className="latest1">
             <div className="line2">
                <h3 className="linehead">Jaisalmer, Rajasthan-The Golden City</h3>
                <p className="linehead1">Jaisalmer is a major tourist spot located in the northwestern state of Rajasthan in India. It is called the 'golden city' due to its bounteous golden dunes flowing in the Thar Desert.</p>
